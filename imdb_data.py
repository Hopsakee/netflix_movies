...
def get_title_details(tt_id: str, max_retries: int = 5) -> dict:
    ...
    is fronted by Cloudflare and rejects concurrent bursts.
    """
...
def get_ratings_by_id(tt_id: str) -> dict:
    ...
    are cached in-process so repeated table renders are free.
    """
    try:
